...
///
/// [`Checkbox`]: ../widget/checkbox/type.Checkbox.html
...
impl CheckboxStyle {
    /// Creates a new [`CheckboxStyle`] from the given [`Palette`].
    ///
    ...
    /// Returns the border color for when the mouse hovers over the [`CheckboxStyle`].
    ///
    /// [`CheckboxStyle`]: struct.CheckboxStyle.html
