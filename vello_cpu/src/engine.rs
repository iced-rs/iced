...
impl Engine {
    ...
    pub fn draw_quad(
        ...
        let paint: vello_cpu::PaintType = match background {
            Background::Color(color) => into_color(*color).into(),
        ...
        render_context.set_aliasing_threshold(None);
...
pub fn into_color(
    ...
    vello_cpu::color::AlphaColor::<vello_cpu::color::Srgb>::new([
...
fn rounded_rectangle(
    ...
    vello_cpu::kurbo::RoundedRect::from_origin_size(
        (bounds.x, bounds.y),
