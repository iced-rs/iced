    ...
    Renderer: crate::core::Renderer,
{
    ...
    fn layout(
        ...
        let align = |column_start: std::ops::Range<usize>,
                     column_width: f32,
        ...
        for (i, child) in self.column.children.iter().enumerate() {
            ...
            if y != 0.0 && y + child_size.height > max_height {
                ...
                align(column_start..i, column_width, &mut children);
        ...
        align(column_start..children.len(), column_width, &mut children);
    ...
    fn overlay<'b>(
        ...
        self.column.overlay(tree, layout, renderer, translation)
    }
}
