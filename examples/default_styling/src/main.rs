...
use iced::{button, scrollable, Button, Column, Container, Element, Length, ProgressBar, Radio, Row, Rule, Sandbox, Scrollable, Settings, Space, Text, Style, Color, Error};
use iced;

pub fn main() -> iced::Result {
    ScrollableDemo::run(Default::default())
}
...
impl Sandbox for ScrollableDemo {
    ...
    fn styling(&self) -> Style {
        ...
        style.button_style_sheet = self.theme.into();
        style
    }
}
